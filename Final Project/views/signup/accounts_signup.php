...
<body>
    ...
    <div class="signup_form">
        <form action="../../controller/accounts_signup_check.php" method="post">
            <div class="background">

                <table class="area">
                    <tr>
                        <td><button class="signup_here">SIGNUP</button></td>
                        <td><button class="signup_here">ACCOUNTS</button></td>
                    </tr>
                    <tr>
                        <td>FirstName</td>
                    ...
                    <tr>
                        <td>Gender</td>
                        <td>
						     <input class="rd" type="radio" name="gender" id="gender">Male
